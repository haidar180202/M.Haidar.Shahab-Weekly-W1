      ...
      <div className="container">
        <div className="w-full px-4">
          <div className="mx-auto mb-16 max-w-xl text-center">
            ...
            <h2 className="mb-4 text-3xl font-bold text-dark dark:text-white sm:text-4xl lg:text-5xl">Contact us</h2>
            <p className="text-md font-medium text-secondary md:text-lg">If you have questions about my profile and want to give me a message send with this to confirm all about me</p>
          </div>
        </div>
