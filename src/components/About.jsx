        ...
        <div className="flex flex-wrap">
          <div className="mb-10 w-full px-4 lg:w-1/2">
            ...
            <p className="max-w-xl text-base font-medium text-secondary lg:text-lg">
              Learn and develop applications with React web and mobile to create
              the application with javascript and have to update it with strong
              javascript like typescript and know about javascript syntax and
              implementation with the clean code and architecture web with react
              like hooks and managing data with context and redux and have to
              implement the design with tailwind css or bootstrap and have
              worked with the version control system like GitLab or GitHub and
              have knowledge of backend engineering systems with Php or Go
            </p>
          </div>
          <div className="w-full px-4 lg:w-1/2">
            ...
            <p className="mb-6 text-base font-medium text-secondary lg:text-lg">
              For my personality if you want to know about me and want to
              connect with me so you can follow me in my others my social media,
              and let's connect
            </p>
