      ...
      <div class="container">
        <div class="flex flex-wrap">
          <div class="mb-12 w-full px-4 font-medium text-slate-300 md:w-1/3">
            <h2 class="mb-5 text-4xl font-bold text-white">M-H-S</h2>
        ...
        <div class="w-full border-t border-slate-700 pt-10">
          ...
          <p class="text-center text-xs font-medium text-slate-500">
            Create with<span class="text-pink-500">❤️</span> by <a href="https://www.instagram.com/muhammad_haidar_syihab/" target="_blank" class="font-bold text-primary">Muhammad Haidar Shahab</a>, with
            <a href="https://tailwindcss.com" target="_blank" class="font-bold text-sky-500 ml-1">React And Tailwind CSS</a>.
          </p>
        </div>
      </div>
    </footer>
