      ...
      <div className="container">
        <div className="relative flex items-center justify-between">
          ...
          <div className="flex items-center px-4">
            ...
            <nav
              id="nav-menu"
              className={`absolute right-4 top-full ${data == "" ? "hidden" : ""} w-full max-w-[250px] rounded-lg bg-white py-5 shadow-lg dark:bg-dark dark:shadow-slate-500 lg:static lg:block lg:max-w-full lg:rounded-none lg:bg-transparent lg:shadow-none lg:dark:bg-transparent`}
            >
              <ul className="block lg:flex">
                ...
                <li className="mt-3 flex items-center pl-8 lg:mt-0">
                  <div className="flex">
                    <span className="mr-2 text-sm text-slate-500 font-bold">light</span>
                    <input type="checkbox" className="hidden" id="dark-toggle" onClick={()=>theme != "dark" ? setTheme("dark") : setTheme("light")} />
                    <label htmlFor="dark-toggle">
                      <div className="flex h-5 w-9 cursor-pointer items-center rounded-full bg-slate-500 p-1">
                        <div className="toggle-circle h-4 w-4 rounded-full bg-white transition duration-300 ease-in-out dark:bg-dark"></div>
                      </div>
                    </label>
                    <span className="ml-2 text-sm text-slate-500 font-bold">dark</span>
                  </div>
                </li>
              </ul>
            </nav>
